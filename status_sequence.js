(function () {
  ...
  function instalarEstilo() {
    ...
    style.textContent = ".execution-plan{display:block}.execution-plan-group+ .execution-plan-group{margin-top:28px}.execution-plan-head{display:flex;justify-content:space-between;gap:18px;align-items:end;margin-bottom:12px}.execution-plan-head h3{margin:0;font-size:16px}.execution-plan-head p{margin:0;max-width:620px;color:var(--muted);font-size:12px;line-height:1.5;text-align:right}.execution-plan-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.execution-card{min-height:150px;padding:18px;border:1px solid var(--border);border-radius:var(--radius);background:var(--surface)}.execution-card.active{border-color:var(--danger);background:var(--danger-soft)}.execution-card-index{color:var(--faint);font-family:var(--mono);font-size:10px;margin-bottom:12px}.execution-card-code{color:var(--blue);font-family:var(--mono);font-size:14px;font-weight:800;margin-bottom:8px}.execution-card-state{display:inline-flex;padding:4px 7px;border-radius:999px;font-size:9px;font-weight:850;letter-spacing:.05em;margin-bottom:10px}.execution-card-state.active{background:var(--danger-soft);color:var(--danger)}.execution-card-state.planned{background:#eef2f5;color:var(--muted)}.execution-card-text{color:var(--muted);font-size:12px;line-height:1.5}.execution-card-source{margin-top:12px;color:var(--faint);font:10px var(--mono);overflow-wrap:anywhere}.execution-empty{padding:18px;border:1px dashed var(--border);border-radius:var(--radius);color:var(--muted);font-size:12px;background:var(--surface)}@media(max-width:960px){.execution-plan-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:700px){.execution-plan-head{display:block}.execution-plan-head p{text-align:left;margin-top:6px}.execution-plan-grid{grid-template-columns:1fr}}";
